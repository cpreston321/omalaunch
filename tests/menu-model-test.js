...
assert(footerDefinitions.map(action => action.id).join(',') === 'primary,refresh,copy,star,actions,settings,capability'
  && footerDefinitions.map(action => action.order).join(',') === '10,20,30,40,50,60,70',
